...
#_(defn resolve [^clojure.lang.Symbol s] (atom (eval s)))

(defn group-symbol [^String group] (symbol (str "group-" group)))

(defn resolve-group [group] (deref (resolve (group-symbol group))))

(defn fields-var-symbol [^String table] (symbol (str table "-fields-var")))

(defn select-symbol [name* ^String table] (symbol (str "select-" (lower-case name*) "-" table)))
...
(defn user-permission-tables-symbol [^String name*] (symbol (str name* "-permission-tables")))

(defn resolve-user-permission-tables [name*] (deref (resolve (user-permission-tables-symbol name*))))
